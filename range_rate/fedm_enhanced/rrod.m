...
options_search = optimset(  'Display','none', ...
                            'TolFun',1e-32, 'TolX', 1e-16);
...
[initGuess,fVal] = ...
        local_search(fun,range_f0,range_e,range_dM,thisRes);
residual = fVal^2;
if residual / residualBest > 0.95
    [initGuess,fVal] = fsolve(fun,initGuess,options_fsolve);
    residual = fVal^2;
%     disp('**fsolve used**')
else
    [initGuess,fVal] = fminsearch(fun,initGuess,options_search);
    residual = fVal^2;
