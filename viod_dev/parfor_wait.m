classdef parfor_wait < handle
   ...
   methods (Access = private)
       ...
       function WaitbarUpdate(Obj)
           ...
           waitbar(Obj.NumMessage/Obj.TotalMessage, Obj.WaitbarHandle, [num2str(Obj.NumMessage/Obj.TotalMessage*100, '%.2f'), '%; ', num2str(UsedTime_now, '%.2f'), 's elapsed.']);
           Obj.UsedTime_1 = UsedTime_now;
       end
       
       function FileUpdate(Obj)
           UsedTime_now = toc(Obj.StartTime);
           fprintf('%.2f%%; %.2fs elapsed.\n', Obj.NumMessage/Obj.TotalMessage*100, UsedTime_now);
           Obj.UsedTime_1 = UsedTime_now;
       end
       function AddOne(Obj)
